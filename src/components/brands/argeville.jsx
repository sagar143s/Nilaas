...
import portDetailsData from "data/quickfynd"; // Replace with Nilaas-specific data if available
import breadcrumbBg from "assets/img/bg/4.jpg";
import Slider from "components/sliderbrands/argeville"; // Replace with Nilaas slider if available
