...
const TestimonialOne = () => {
    ...
    return (
        <div className="brook-testimonial-area bg_color--7">
            <Row className="row--0 align-items-center">
                ...
                <Col lg={8}>
                    <SlickSlider
                        settings={settings}
                        classes="brook-element-carousel slick-arrow-center slick-arrow-triangle slick-arrow-trianglestyle-2 testimonial-space-right testimonial-color-variation"
                    >
