...
const ComingSoonContent = () => {
    return (
        <div className="page-template-coming-soon bg_color--3 text-center text-md-start">
            <div className="site">
                <Row>
                    <Col
                        xs={{order:2}}
                        lg={{span:4, order:1}}
                        xl={6}
                        className="d-none d-lg-block h-100vh"
                        style={{backgroundImage: `url(${comingBg})`, backgroundSize: 'cover'}}
                    />

                    <Col xs={{order:1}} lg={{span:8, order:2}} xl={6} className="d-flex align-items-center h-100vh">
                                ...
                                <div className="content mt--95 mt_lg--30 mt_md--30 mt_sm--30">
                                    ...
                                    <div
                                        ...
                                        <div className="countbox timer-grid">
                                            <Countdown date="2023-04-15" renderer={Renderer}/>
                                        </div>
                                    </div>
                                </div>
